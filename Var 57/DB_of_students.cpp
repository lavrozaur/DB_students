...
int main()
{
    ...
    mainMenu->addItem("Выполнить вариант 57"); //3
    ...
    while (resultSelectedItem != exitInt) {
        ...
        case 3: //Вариант 57
            ...
            cout << "Вывести списки всех студентов, у которых за все время обучения не более 25% оценок:" << endl;
            cout << "1) 3" << endl;
            cout << "2) 3 и 4" << endl;
            cout << "3) 5" << endl;
            cout << "4) 3 и 5" << endl;
            ...
            for (int k = 0; k < callFun.length(); k++)
            {
                char charCall = callFun[k];
                int countFun = (int)callFun[k] - '0';
                sdb->sortOnYear(countFun);
